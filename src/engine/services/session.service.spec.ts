...
import { createTestMovement, createTestSession, createTestDecision } from '../../../test/unit/fixtures/entities';
...
describe('SessionService', () => {
    ...
    describe('processMovement', () => {
        ...
        it('should close existing session for EXIT movement', async () => {
            ...
            jest.spyOn(sessionRepo, 'save').mockResolvedValue(closedSession as Session);
