...
export class EnforcementController {
    ...
    async reviewDecision(
        @Param('id') id: string,
        @Body() body: { action: 'APPROVE' | 'DECLINE'; operatorId: string; notes?: string },
    ) {
        return this.enforcementService.reviewDecision(id, body.action, body.operatorId, body.notes);
    }
}
