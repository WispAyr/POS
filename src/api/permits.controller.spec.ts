...
describe('PermitsController', () => {
  ...
  beforeEach(async () => {
    ...
    mondayService = module.get<MondayIntegrationService>(
  ...
  describe('create', () => {
    it('should create permit and push to Monday for WHITELIST', async () => {
      ...
      jest
        .spyOn(mondayService, 'pushPermitToMonday')
      ...
      expect(mondayService.pushPermitToMonday).toHaveBeenCalledWith(
        savedPermit,
      );
    });
  ...
  describe('update', () => {
    it('should update permit and sync to Monday for WHITELIST', async () => {
      ...
      expect(mondayService.updatePermitOnMonday).toHaveBeenCalledWith(
        updatedPermit,
      );
    });
    ...
    it('should normalize VRM if provided in update', async () => {
      ...
      // Assert
      expect(permitRepo.update).toHaveBeenCalledWith(permitId, {
        vrm: 'NEWVRM',
      });
    });
  });
  ...
  describe('remove', () => {
    it('should delete permit and remove from Monday if mondayItemId exists', async () => {
      ...
      expect(mondayService.deletePermitFromMonday).toHaveBeenCalledWith(
        'monday-123',
      );
