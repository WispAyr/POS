          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {version.gitCommit && (
              <div>
                ...
                <p className="text-sm font-mono text-gray-900 dark:text-white">
                  {formatCommit(version.gitCommit)}
                </p>
              </div>
            )}
            {version.gitBranch && (
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            ...
            <select
              ...
              onChange={(e) =>
                setFilter({ ...filter, buildType: e.target.value || undefined })
              }
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <span
                        className={`px-2 py-1 rounded text-xs font-medium ${getStatusColor(build.status)}`}
                      >
                        {build.status}
                      </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="text-sm text-gray-900 dark:text-white">
                    ...
                    {build.version.gitCommit && (
                      <p className="font-mono text-xs">
                        Commit: {formatCommit(build.version.gitCommit)}
                      </p>
                    )}
                  </div>
                </div>
                {build.testResults && (
                  <div>
                    ...
                    <div className="text-sm text-gray-900 dark:text-white">
                      <p>
                        Passed: {build.testResults.passed} /{' '}
                        {build.testResults.total}
                      </p>
                      {build.testResults.coverage && (
                        <p>
                          Coverage:{' '}
                          {build.testResults.coverage.lines.toFixed(1)}%
                        </p>
                      )}
                    </div>
                  </div>
                ...
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {build.artifacts.map((artifact, idx) => (
                      <span
                        key={idx}
                        className="text-xs px-2 py-1 bg-gray-100 dark:bg-slate-800 rounded text-gray-700 dark:text-gray-300"
                      >
                        {artifact}
                      </span>
                    ))}
